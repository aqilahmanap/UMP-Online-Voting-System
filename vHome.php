...
$sql = "SELECT cID, cName, cManifesto FROM manifesto WHERE cID='CB18116'";
...
<tr>
	...
	<td><center><img src="assets/img/1616993460_IMG_9505-copy.jpg" alt="" width="100" height="100"></center></td> 
	<td><?=$row["cID"]?></td>
	<td><?=$row["cName"]?></td>
	<td><?=$row["cManifesto"]?></td>
...
<form method="post" action="sHomepage.php?page=shome"><input type="submit" name="Back" value="Back"></form>
</center>
