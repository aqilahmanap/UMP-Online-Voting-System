...
Class Action {
	...
	//FUNCTION FOR USER TO LOGIN INTO THE SYSTEM
	function login(){
	extract($_POST);
	...
	//FUNCTION FOR USER TO LOGOUT FROM THE SYSTEM
	function logout(){
	session_destroy();
	...
	//FUNCTION TO SAVE FILES INTO DATABASE
	function save_files(){
	extract($_POST);
	if(empty($id)){
	...
	//FUNCTION FOR ADMIN TO SAVE NEW USER INTO THE DATABASE
	function save_user(){
	extract($_POST);
	$data = " name = '$name' ";
	...
	//FUNCTION FOR ADMIN TO SAVE NEW CATEGORY INTO THE DATABASE
	...
	//FUNCTION FOR ADMIN TO DELETE CATEGORY FROM THE DATABASE
	...
	//FUNCTION FOR ADMIN TO SAVE NEW VOTING TITLE INTO THE DATABASE
	...
	//FUNCTION TO DISPLAY VOTING LIST FROM THE DATABASE
	function get_voting(){
		extract($_POST);
	...
	//FUNCTION FOR ADMIN TO DELETE VOTING LIST FROM THE DATABASE
	...
	//FUNCTION FOR ADMIN TO UPDATE VOTING LIST 
	...
	//FUNCTION FOR ADMIN TO VOTING OPTIONS FROM THE DATABASE
	function save_opt(){
		extract($_POST);
	...
	//FUNCTION FOR ADMIN TO DELETE CANDIDATE FROM THE DATABASE
	...
	//FUNCTION FOR ADMIN TO CATEGORY INTO THE DATABASE
	...
	//FUNCTION FOR USER TO SUBMIT VOTE FOR CANDIDATES
	...
	//FUNCTION FOR CANDIDATES TO SAVE MANIFESTO INTO THE DATABASE
	function save_manifesto(){
	extract($_POST);
	$data = " manifesto = '$manifesto' ";
		if(empty($id)){
		$save = $this->db->query("INSERT INTO manifesto(cManifesto) set ".$data." where cID =".$c);
			if($save)
				return 1;
		}
		else{
