	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
				...
				<hr>
				<button class="btn-block btn-primary" onclick="verifyVote()">Submit</button>
				</form>
			</div>
		</div>
	</div>
...
function verifyVote() {
        var txt;
        var r = confirm("Verification is needed to finish voting process. Perform verification?");
    if (r == true) {
        txt =   window.open("https://teams.microsoft.com/l/meetup-join/19%3aE9xY7L6kPCP5Nff2Ddx7r6y4qVV_5hDVigoSgqRfWNY1%40thread.tacv2/1623104958912?context=%7b%22Tid%22%3a%227f048fc1-2ea3-48e4-ac92-91d1eb09807c%22%2c%22Oid%22%3a%2255505bce-50b8-40c5-9b50-fa946d86de7d%22%7d", "_blank");;
    } else {
      txt = "Verification cancelled";
    }
